...
export declare const TwLoading: {
...
export declare const TwLoadingDirective: import("vue").Directive<import("./src/directive").ElementLoading, import("./src/directive").LoadingBinding>;
export declare const TwLoadingService: (options?: Partial<Omit<import("./src/types").LoadingOptionsResolved, "target" | "parent"> & {
    target: string | HTMLElement;
    body: boolean;
}>) => {
    setText: (text: string) => void;
