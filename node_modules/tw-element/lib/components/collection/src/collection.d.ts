...
import type { TwCollectionInjectionContext, TwCollectionItemInjectionContext } from './tokens';
...
export declare const createCollectionWithScope: (name: string) => {
    COLLECTION_INJECTION_KEY: InjectionKey<TwCollectionInjectionContext>;
    COLLECTION_ITEM_INJECTION_KEY: InjectionKey<TwCollectionItemInjectionContext>;
    TwCollection: {
        name: string;
        setup(): void;
