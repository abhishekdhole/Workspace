...
const _sfc_main = vue.defineComponent({
  ...
  setup(props) {
    ...
    const finalCancTwButtonText = vue.computed(() => props.cancTwButtonText || t("el.popconfirm.cancTwButtonText"));
    return {
      ...
      vue.createElementVNode("div", {
        ...
        vue.createElementVNode("div", {
          ...
          vue.createVNode(_component_el_button, {
            ...
            default: vue.withCtx(() => [
              vue.createTextVNode(vue.toDisplayString(_ctx.finalCancTwButtonText), 1)
            ]),
            _: 1
          }, 8, ["type", "onClick"]),
          vue.createVNode(_component_el_button, {
