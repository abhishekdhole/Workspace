...
const TwRadio = install.withInstall(radio$1["default"], {
  RadioButton: radioButton$1["default"],
  RadioGroup: radioGroup$1["default"]
});
const TwRadioGroup = install.withNoopInstall(radioGroup$1["default"]);
const TwRadioButton = install.withNoopInstall(radioButton$1["default"]);
...
exports.TwRadio = TwRadio;
exports.TwRadioButton = TwRadioButton;
exports.TwRadioGroup = TwRadioGroup;
