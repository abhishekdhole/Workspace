...
const _sfc_main = vue.defineComponent({
  name: COMPONENT_NAME,
  components: {
    TwCascaderPanel: index["default"],
    TwInput: index$1.TwInput,
    ElTooltip: index$2.TwTooltip,
    TwScrollbar: index$3.TwScrollbar,
    TwTag: index$4.TwTag,
    TwIcon: index$5.TwIcon,
  ...
  setup(props, { emit }) {
    ...
    const isDisabled = vue.computed(() => props.disabled || TwForm.disabled);
