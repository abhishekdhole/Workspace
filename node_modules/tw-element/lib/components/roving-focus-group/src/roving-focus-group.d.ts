...
export declare const rovingFocusGroupProps: {
    ...
    currentTabId: import("tw-element/es/utils").BuildPropReturn<import("tw-element/es/utils").PropWrapper<string | null>, unknown, unknown, unknown, unknown>;
    defaultCurrentTabId: StringConstructor;
    loop: BooleanConstructor;
    dir: import("tw-element/es/utils").BuildPropReturn<StringConstructor, string, unknown, string, unknown>;
    orientation: import("tw-element/es/utils").BuildPropReturn<import("tw-element/es/utils").PropWrapper<"horizontal" | "vertical" | undefined>, unknown, unknown, unknown, unknown>;
...
export { TwCollection, TwCollectionItem, COLLECTION_INJECTION_KEY as ROVING_FOCUS_COLLECTION_INJECTION_KEY, COLLECTION_ITEM_INJECTION_KEY as ROVING_FOCUS_ITEM_COLLECTION_INJECTION_KEY, };
