...
const _sfc_main = vue.defineComponent({
  name: "TwColorPicker",
  components: {
    TwButton: index.TwButton,
    ElTooltip: index$1.TwTooltip,
    TwInput: index$2.TwInput,
    TwIcon: index$3.TwIcon,
  ...
  setup(props, { emit }) {
    ...
    const TwForm = vue.inject(form.twFormKey, {});
    const TwFormItem = vue.inject(form.twFormItemKey, {});
    ...
    const showPanTwColor = vue.ref(false);
    ...
    const currentColor = vue.computed(() => {
      return !props.modelValue && !showPanTwColor.value ? "" : color$1.value;
    });
          ...
          vue.createElementVNode("span", {
            ...
            vue.createElementVNode("span", {
              ...
              vue.withDirectives(vue.createVNode(_component_el_icon, {
                ...
                [vue.vShow, _ctx.modelValue || _ctx.showPanTwColor]
              ]),
              !_ctx.modelValue && !_ctx.showPanTwColor ? (vue.openBlock(), vue.createBlock(_component_el_icon, {
                key: 0,
