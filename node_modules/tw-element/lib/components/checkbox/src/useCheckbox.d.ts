...
import type { TwFormContext, TwFormItemContext } from 'tw-element/es/tokens';
...
export declare const useCheckboxGroup: () => {
    ...
    TwForm: TwFormContext;
    TwFormItemSize: import("vue").ComputedRef<"default" | "small" | "large" | undefined>;
    TwFormItem: TwFormItemContext;
};
