...
var TabNav = vue.defineComponent({
  ...
  setup(props, { expose }) {
    ...
    if (!rootTabs)
      error.throwError(COMPONENT_NAME, `ElTabNav must be nested inside TwTabs`);
    ...
    return () => {
      const scrollBtn = scrollable.value ? [
        vue.h("span", {
          ...
          onClick: scrollPrev
        }, [vue.h(index.TwIcon, {}, { default: () => vue.h(iconsVue.ArrowLeft) })]),
        vue.h("span", {
          class: [
            "el-tabs__nav-next",
          ...
          onClick: scrollNext
        }, [vue.h(index.TwIcon, {}, { default: () => vue.h(iconsVue.ArrowRight) })])
      ] : null;
      const tabs = props.panes.map((pane, index$1) => {
        ...
        pane.index = `${index$1}`;
        const btnClose = closable ? vue.h(index.TwIcon, {
          class: "is-icon-close",
