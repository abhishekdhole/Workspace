...
const useSelect = (props, emit) => {
  ...
  const { form: TwForm, formItem: TwFormItem } = index$2.useFormItem();
  ...
  const selectDisabled = vue.computed(() => props.disabled || (TwForm == null ? void 0 : TwForm.disabled));
  ...
  const validateState = vue.computed(() => (TwFormItem == null ? void 0 : TwFormItem.validateState) || "");
  ...
  vue.watch(() => props.modelValue, (val, oldVal) => {
    ...
    if (!lodashUnified.isEqual(val, oldVal)) {
      (_a = TwFormItem == null ? void 0 : TwFormItem.validate) == null ? void 0 : _a.call(TwFormItem, "change");
    }
  }, {
    deep: true
  });
