export declare const TwTable: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    data: {
...
export declare const TwTableColumn: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    type: {
        type: StringConstructor;
        default: string;
    };
