...
const _sfc_main = vue.defineComponent({
  ...
  components: {
    ...
    TwButtonGroup: index.TwButtonGroup
  },
  ...
  setup(props, { emit }) {
    ...
    const calculateValidatedDateRange = (startDayjs, endDayjs) => {
      ...
      if (firstMonth === lastMonth) {
        ...
        error.debugWarn("TwCalendar", "start time and end time interval must not exceed two months");
        return [];
      }
    };
    const validatedRange = vue.computed(() => {
      ...
      if (startDayjs.isAfter(endDayjs)) {
        error.debugWarn("TwCalendar", "end time should be greater than start time");
        return [];
      }
