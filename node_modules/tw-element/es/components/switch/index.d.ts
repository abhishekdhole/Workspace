export declare const TwSwitch: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly beforeChange: import("tw-element/es/utils").BuildPropReturn<import("tw-element/es/utils").PropWrapper<() => boolean | Promise<boolean>>, unknown, unknown, unknown, unknown>;
    ...
    loading: import("tw-element/es/utils").BuildPropType<BooleanConstructor, unknown, unknown>;
    name: string;
    modelValue: import("tw-element/es/utils").BuildPropType<readonly [BooleanConstructor, StringConstructor, NumberConstructor], unknown, unknown>;
    width: number;
    borderColor: string;
    validateEvent: import("tw-element/es/utils").BuildPropType<BooleanConstructor, unknown, unknown>;
    value: import("tw-element/es/utils").BuildPropType<readonly [BooleanConstructor, StringConstructor, NumberConstructor], unknown, unknown>;
    inlinePrompt: import("tw-element/es/utils").BuildPropType<BooleanConstructor, unknown, unknown>;
    activeIcon: import("tw-element/es/utils").BuildPropType<import("tw-element/es/utils").PropWrapper<string | import("vue").Component<any, any, any, import("vue").ComputedOptions, import("vue").MethodOptions>>, unknown, unknown>;
    inactiveIcon: import("tw-element/es/utils").BuildPropType<import("tw-element/es/utils").PropWrapper<string | import("vue").Component<any, any, any, import("vue").ComputedOptions, import("vue").MethodOptions>>, unknown, unknown>;
    activeText: string;
    inactiveText: string;
    activeColor: string;
    inactiveColor: string;
    activeValue: import("tw-element/es/utils").BuildPropType<readonly [BooleanConstructor, StringConstructor, NumberConstructor], unknown, unknown>;
    inactiveValue: import("tw-element/es/utils").BuildPropType<readonly [BooleanConstructor, StringConstructor, NumberConstructor], unknown, unknown>;
