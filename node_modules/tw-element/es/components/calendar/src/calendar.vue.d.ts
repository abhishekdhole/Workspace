...
declare const _default: import("vue").DefineComponent<{
    readonly modelValue: import("tw-element/es/utils").BuildPropReturn<DateConstructor, unknown, unknown, unknown, unknown>;
    readonly range: import("tw-element/es/utils").BuildPropReturn<import("tw-element/es/utils").PropWrapper<[Date, Date]>, unknown, unknown, unknown, [Date, Date]>;
}, {
