...
export declare type TwMessageBoxShortcutMethod = ((message: TwMessageBoxOptions['message'], title: TwMessageBoxOptions['title'], options?: TwMessageBoxOptions) => Promise<MessageBoxData>) & ((message: TwMessageBoxOptions['message'], options?: TwMessageBoxOptions) => Promise<MessageBoxData>);
