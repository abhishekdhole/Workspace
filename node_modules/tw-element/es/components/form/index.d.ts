export declare const TwForm: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
...
export declare const TwFormItem: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    label: StringConstructor;
    labelWidth: {
        type: (StringConstructor | NumberConstructor)[];
        default: string;
