...
declare const _Slider: SFCWithInstall<import("vue").DefineComponent<{
    ...
    slider: import("vue").ShallowRef<import("tw-element/es/utils").Nullable<HTMLElement>>;
    ...
    sliderWrapper: import("vue").Ref<import("tw-element/es/utils").Nullable<HTMLElement>>;
...
export declare const TwSlider: SFCWithInstall<import("vue").DefineComponent<{
    modelValue: {
        type: import("vue").PropType<number | number[]>;
        default: number;
    };
