...
declare const _Tree: SFCWithInstall<import("vue").DefineComponent<{
    ...
    el$: import("vue").Ref<import("tw-element/es/utils").Nullable<HTMLElement>>;
    dropIndicator$: import("vue").Ref<import("tw-element/es/utils").Nullable<HTMLElement>>;
...
export declare const TwTree: SFCWithInstall<import("vue").DefineComponent<{
    data: {
        type: ArrayConstructor;
        default: () => never[];
    };
