...
const useSelect = (props, emit) => {
  ...
  const selectDisabled = computed(() => props.disabled || (TwForm == null ? void 0 : TwForm.disabled));
  ...
  const validateState = computed(() => (TwFormItem == null ? void 0 : TwFormItem.validateState) || "");
