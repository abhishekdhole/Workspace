export declare const TwSteps: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    space: {
...
export declare const TwStep: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    title: {
        type: StringConstructor;
        default: string;
    };
