export declare const TwCheckbox: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    modelValue: {
...
export declare const TwCheckboxButton: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    modelValue: {
        type: (BooleanConstructor | StringConstructor | NumberConstructor)[];
        default: () => undefined;
    };
...
export declare const TwCheckboxGroup: import("tw-element/es/utils").SFCWithInstall<import("vue").DefineComponent<{
    modelValue: {
        type: ArrayConstructor;
        default: () => never[];
    };
