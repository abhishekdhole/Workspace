...
declare const _Upload: SFCWithInstall<import("vue").DefineComponent<{
    ...
    limit: {
        type: import("vue").PropType<import("tw-element/es/utils").Nullable<number>>;
        default: null;
    };
    onExceed: {
        type: FunctionConstructor;
    ...
    handleProgress: (ev: import("./src/upload.type").TwUploadProgressEvent, rawFile: import("./src/upload.type").ElFile) => void;
    ...
    limit: import("tw-element/es/utils").Nullable<number>;
    onExceed: Function;
    showFileList: boolean;
    beforeRemove: import("./src/upload.type").FileHandler<boolean>;
}>>;
export default _Upload;
export declare const TwUpload: SFCWithInstall<import("vue").DefineComponent<{
    action: {
        type: StringConstructor;
        required: true;
    };
