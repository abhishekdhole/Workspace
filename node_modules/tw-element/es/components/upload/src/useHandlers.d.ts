...
import type { UploadFile, UploadStatus, ElFile, TwUploadProgressEvent, IUseHandlersProps } from './upload.type';
declare const _default: (props: IUseHandlersProps) => {
    ...
    handleProgress: (ev: TwUploadProgressEvent, rawFile: ElFile) => void;
